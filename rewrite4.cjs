...
export default function App() {
  ...
  const handleTerminalSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      let reply = 'Command not recognized. Please ask about my Safaricom experience, Tech Stack, EduManage, or Utu Engineering philosophy.';
      ...
      if (lower.includes('safaricom') || lower.includes('experience')) {
        ...
        reply = '"Utu Engineering" focuses on structural empathy and stewardship. Engineering is a service to people. I design systems that anticipate offline states and physical limits, ensuring data sovereignty and resilience in low-connectivity environments.';
      } else if (lower.includes('ansai')) {
        reply = 'Ansai Technologies is a Nairobi-based company building digital infrastructure for African institutions. I architected the full stack using Render, Cloudflare Pages, R2 storage, and strict RBAC adhering to the Kenya Data Protection Act 2019.';
      }
        ...
        <div className="relative flex justify-center items-center h-[500px] lg:h-[700px] order-1 lg:order-2">
          ...
          <div className="relative w-[280px] h-[380px] md:w-[380px] md:h-[500px] z-10">
             <div className="absolute inset-0 bg-[#E8E3D9] rounded-tl-[100px] rounded-br-[100px] rounded-tr-3xl rounded-bl-3xl overflow-hidden border-[12px] border-white shadow-2xl flex flex-col items-center justify-center transform rotate-3 hover:rotate-0 transition-transform duration-500">
                ...
                <div className="absolute inset-0 bg-cover bg-center opacity-80" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1573164713988-8665fc963095?q=80&w=1000&auto=format&fit=crop")' }}></div>
                ...
                <div className="relative z-10 bg-white/95 backdrop-blur-md px-5 py-2.5 rounded-full shadow-lg border border-neutral-100 flex items-center gap-2">
                  ...
                  <span className="font-black text-[#1C1D20] uppercase tracking-widest text-[10px]">Insert Red Bow-Tie Photo</span>
                </div>
             </div>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="space-y-10 flex flex-col justify-center">
            ...
            <div className="space-y-6 text-xl text-neutral-600 font-medium leading-relaxed">
              <p>
                My work centers on the conviction that engineering is fundamentally a service to people. Integrity, stewardship, and structural resilience govern every architectural decision.
              </p>
              <p className="p-6 bg-[#FDF9F1] rounded-3xl border border-[#FFC83A]/30 text-[#1C1D20]">
                As a <strong className="text-[#FFC83A] font-black mr-1">Systems Thinker &amp; Ecosystem Builder</strong>, 
                I design multi-tenant infrastructures that anticipate network loss and physical disruption. Guided by a commitment to ethical design, I build platforms and communities that empower others to innovate securely across Africa.
              </p>
            </div>
          ...
          <div className="max-w-5xl mx-auto space-y-16 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-1 before:bg-gradient-to-b before:from-transparent before:via-neutral-300 before:to-transparent">
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
               ...
               <div className="w-[calc(100%-4.5rem)] md:w-[calc(50%-3rem)] bg-white p-8 rounded-[2rem] shadow-xl border border-neutral-100 hover:-translate-y-2 transition-transform duration-300">
                 ...
                 <div className="mb-5 h-48 w-full rounded-xl bg-neutral-100 border border-neutral-200 overflow-hidden relative">
                    <div className="absolute inset-0 bg-cover bg-center opacity-90" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1544531586-fde5298cdd40?q=80&w=1000&auto=format&fit=crop")' }}></div>
                    <div className="absolute inset-0 bg-[#1B4B43]/10 mix-blend-multiply"></div>
                    <div className="absolute inset-0 flex items-center justify-center">
                       <span className="bg-white/95 backdrop-blur-md px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest text-[#1C1D20] shadow-sm flex items-center gap-2">
                         <ImageIcon className="w-3 h-3" /> Insert Outdoor Speaking Photo
                       </span>
                    </div>
                 </div>
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
               ...
               <div className="w-[calc(100%-4.5rem)] md:w-[calc(50%-3rem)] bg-white p-8 rounded-[2rem] shadow-xl border border-neutral-100 hover:-translate-y-2 transition-transform duration-300">
                 ...
                 <div className="mb-5 h-48 w-full rounded-xl bg-neutral-100 border border-neutral-200 overflow-hidden relative">
                    <div className="absolute inset-0 bg-cover bg-center opacity-90" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1540575467063-178a50c2df87?q=80&w=1000&auto=format&fit=crop")' }}></div>
                    <div className="absolute inset-0 bg-blue-900/10 mix-blend-multiply"></div>
                    <div className="absolute inset-0 flex items-center justify-center">
                       <span className="bg-white/95 backdrop-blur-md px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest text-[#1C1D20] shadow-sm flex items-center gap-2">
                         <ImageIcon className="w-3 h-3" /> Insert DevFest 2023 Photo
                       </span>
                    </div>
                 </div>
